...
public class ModifierHooksRegistry {
    ...
    public static final ModuleHook<AfterAttackerWithEquipmentModifyDamageModifierHook> AFTER_ATTACKER_MODIFY_HURT;
    public static final ModuleHook<AfterAttackerWithEquipmentModifyDamageModifierHook> AFTER_ATTACKER_MODIFY_DAMAGE;
    static {
        Function<Collection<AfterAttackerWithEquipmentModifyDamageModifierHook>,AfterAttackerWithEquipmentModifyDamageModifierHook> merger = AfterAttackerWithEquipmentModifyDamageModifierHook.AllMerger::new;
        AfterAttackerWithEquipmentModifyDamageModifierHook fallback = (tool, modifier, context, slotType, source,amount , isDirectDamage) -> {};
        AFTER_ATTACKER_MODIFY_HURT = register("after_attacker_modify_hurt", AfterAttackerWithEquipmentModifyDamageModifierHook.class, merger, fallback);
        AFTER_ATTACKER_MODIFY_DAMAGE = register("after_attacker_modify_damage", AfterAttackerWithEquipmentModifyDamageModifierHook.class, merger, fallback);
    }

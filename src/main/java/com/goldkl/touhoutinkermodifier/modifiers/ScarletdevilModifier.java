...
public class ScarletdevilModifier extends Modifier implements NightVisionHook {
    ...
    protected void registerHooks(ModuleHookMap.Builder hookBuilder) {
        ...
        hookBuilder.addModule(AttributeModule.builder(AttributeRegistry.BLOOD_SPELL_POWER.get(), AttributeModifier.Operation.MULTIPLY_BASE).uniqueFrom(TTMModifierIds.scarletdevil).eachLevel(0.3f));
        hookBuilder.addModule(AttributeModule.builder(PerkAttributes.MANA_REGEN_BONUS.get(), AttributeModifier.Operation.ADDITION).uniqueFrom(TTMModifierIds.scarletdevil).eachLevel(40f));
